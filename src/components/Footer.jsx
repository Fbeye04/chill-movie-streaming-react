...
const Footer = () => {
  ...
  return (
    <footer className='flex flex-col lg:flex-row lg:justify-between p-5 md:py-14 md:px-20 border-t border-border-light'>
      ...
      <div>
        <div
          className='text-white mb-3 flex justify-between items-center cursor-pointer md:cursor-default'
        ...
        <ul
          ...
          } lg:grid lg:grid-cols-4 gap-x-8 gap-y-3 text-secondary`}>
      ...
      <div className='mt-4 lg:mt-0'>
        ...
        <ul
          className={`${isHelpOpen ? "flex flex-col gap-3 text-secondary" : "hidden"}`}>
