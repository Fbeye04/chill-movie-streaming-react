...
const Header = () => {
  ...
  return (
    <header className='py-4 px-6 md:py-6 md:px-20 flex justify-between items-center md:gap-12 sticky top-0 w-full z-50 bg-primary backdrop-blur-sm'>
      <div className='flex gap-3 lg:gap-20 items-center'>
        <Logo textCustom='hidden lg:flex lg:text-3xl' imgCustom='w-6 md:w-7' />

        <nav>
          <ul className='flex gap-4 lg:gap-20 text-white list-none'>
            <li className='cursor-pointer hover:text-blue-500 transition-colors'>
              <Link to='/' className='text-sm md:text-lg font-medium'>
                Series
              </Link>
            </li>
            <li className='cursor-pointer hover:text-blue-500 transition-colors'>
